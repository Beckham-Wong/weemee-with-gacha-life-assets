<html style="--wm-toolbar-height: 1px;"><head lang="EN-UK"><style>body {transition: opacity ease-in 0.2s; } 
body[unresolved] {opacity: 0; display: block; overflow: hidden; position: relative; } 
</style><script src="//archive.org/includes/athena.js" type="text/javascript"></script>
<script type="text/javascript">window.addEventListener('DOMContentLoaded',function(){var v=archive_analytics.values;v.service='wb';v.server_name='wwwb-app203.us.archive.org';v.server_ms=1925;archive_analytics.send_pageview({});});</script>
...
<script type="text/javascript">
  ...
  __wm.wombat("http://saw-you.com:80/flash/menu.aspx","20030713125145","https://web.archive.org/","web","https://web-static.archive.org/_static/",
	      "1058100705");
</script>
...
<!-- End Wayback Rewrite JS Include -->
		...
		<title>WeeMee with Gacha Life assets</title>
...
function launchwin(winurl,winname,winHeight,winWidth)
{
	...
	if(javascript_version > 1.0)
	{
		...
		function popupTerms(){
			window.open('https://web.archive.org/web/20030713125145/http://www.saw-you.com/terms-popup.aspx','','toolbar=no,status=no,menubar=no,scrollbars=yes,location=no,width=400,height=440');
		}

function sawYouBiz(){
	window.open('https://web.archive.org/web/20030713125145/http://www.saw-you.biz/','SAW-YOU.BIZ','toolbar=yes,menubar=yes,scrollbars=yes,');
}


		</script>
		<link rel="stylesheet" type="text/css" href="https://beckham-wong.github.io/weemee-with-gacha-life-assets/css/global.css?wl=saw-you">
	<style>undefined</style></head>
	<body class="mainframe" marginheight="0" marginwidth="0" leftmargin="0" topmargin="0">
 
		<object id="SAWYOU" codebase="https://web.archive.org/web/20030713125145oe_/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" height="450" width="400" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" viewastext="">
